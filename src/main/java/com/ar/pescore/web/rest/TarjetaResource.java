...
/**
 * REST controller for managing {@link com.ar.pescore.domain.Tarjeta}.
 */
@RestController
@RequestMapping("/api")
public class TarjetaResource {
    ...
    public ResponseEntity<TarjetaDTO> createTarjeta(@RequestBody TarjetaDTO tarjetaDTO) throws URISyntaxException {
     ...
     */
    @PutMapping("/tarjetas")
    public ResponseEntity<TarjetaDTO> updateTarjeta(@RequestBody TarjetaDTO tarjetaDTO) throws URISyntaxException {
